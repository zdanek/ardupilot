...
#if AP_AIRSPEED_ENABLED == 0
#undef AP_AIRSPEED_BACKEND_DEFAULT_ENABLED
...
#undef AP_AIRSPEED_SITL_ENABLED
#undef AP_AIRSPEED_AUAV_ENABLED
#undef AP_AIRSPEED_AUTOCAL_ENABLE
#undef AP_AIRSPEED_HYGROMETER_ENABLE
#undef AP_AIRSPEED_EXTERNAL_ENABLED
#endif
